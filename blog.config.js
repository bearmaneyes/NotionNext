...
const BLOG = {
  ...
  NOTION_PAGE_ID: 
    ...
    '31ade793f7534bffb30bc410323733f9,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Bearmaneyes', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '闲云野鹤', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bearman.vercel.app', // 网站地址
  ...
  POST_PREVIEW_LINES: process.env.NEXT_PUBLIC_POST_POST_PREVIEW_LINES: 3 || 3, // 预览博客行数
  POST_RECOMMEND_COUNT: process.env.NEXT_PUBLIC_POST_RECOMMEND_COUNT: 6 || 6, // 推荐文章数量
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POST_PER_PAGE: 12 || 12, // post counts per page
